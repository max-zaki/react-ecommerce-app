  ...
  const handleCheckout = async () => {
    ...
    try {
      await createOrder({
        ...
        items: items.map(({ id, title, price, count, image, category }) => ({
          id, title, price, count, image, category,
        })),
    ...
    return (
      <main className="cart-page">
        <div className="checkout-success">
          ...
          <p>Your order has been saved. View it in your order history.</p>
          <div className="success-actions">
            <Link to="/orders" className="continue-shopping-btn">View My Orders</Link>
            <Link to="/" className="btn-secondary-link">Continue Shopping</Link>
          </div>
        </div>
      </main>
    );
    ...
    <main className="cart-page">
      ...
      <div className="cart-layout">
              ...
              <div className="cart-item-details">
                ...
                <div className="cart-item-controls">
                  <div className="quantity-controls">
                    <button className="qty-btn" onClick={() => dispatch(updateQuantity({ id: item.id, count: item.count - 1 }))}>−</button>
        ...
        <div className="cart-summary">
          ...
          {!currentUser && (
            <p className="auth-notice">Please <Link to="/login">log in</Link> to checkout.</p>
          )}
